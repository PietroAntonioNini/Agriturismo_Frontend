    ...
    <style>
        * {
        ...
        @media print {
            ...
            .inventory-section { display: block; } /* Mostra inventario in stampa */
        }
...
<body>
        ...
        <div class="content">
                ...
                <div class="parties-grid">
                    <div class="party-box">
                        ...
                        <div class="field-group">
                            ...
                            <div class="field-value" style="text-transform: uppercase;">${tenant.documentNumber}</div>
                        </div>
                        <div class="field-group">
                ...
                <div class="utilities-section">
                    ...
                    <div class="utilities-grid">
                        <div class="utility-box">
                            ...
                            <div class="text-small" style="margin-top: 5px; color: #666;">m3</div>
                        </div>
                        <div class="utility-box">
            ...
            <div class="section">
                ...
                <div class="financial-section">
                    <div class="financial-grid" style="display: flex; align-items: center; justify-content: center;">
    ...
    private addInventoryPage(doc: jsPDF, apartment: Apartment): void {
        ...
        doc.rect(15, yPos, 180, 150);

        yPos += 10;
        doc.setFont('helvetica', 'bold');
        doc.text(`Appartamento: ${apartment.name}`, 20, yPos);
        yPos += 10;

        doc.setFont('helvetica', 'normal');
        doc.text('Lista dei beni mobili presenti nell\'immobile:', 20, yPos);
        yPos += 12;

        const inventoryItems = [
            { label: 'Cucina attrezzata e elettrodomestici', checked: apartment.isFurnished },
            { label: 'Camera letto completa', checked: apartment.isFurnished },
            { label: 'Soggiorno: divano, tavolo, sedie', checked: apartment.isFurnished },
            { label: 'Bagno: sanitari e accessori', checked: apartment.isFurnished },
            { label: 'Televisore e mobiletto TV', checked: apartment.isFurnished },
            { label: 'Armadi e cassettoni', checked: apartment.isFurnished },
            { label: 'Altro: _________________', checked: apartment.isFurnished }
        ];

        inventoryItems.forEach(item => {
            // Disegna quadratino checkbox
            doc.rect(20, yPos - 4, 4, 4);
            if (item.checked) {
                doc.line(20, yPos - 4, 24, yPos);
                doc.line(24, yPos - 4, 20, yPos);
            }
        ...
        yPos += 10;
        doc.setFontSize(10);
        const notice = 'La presente descrizione è quella dei beni arredati presenti al momento della consegna dell\'immobile. ' +
            'Eventuali danni o deterioramenti dovranno essere risarciti.';
        yPos += this.addWrappedText(doc, notice, yPos, 170);

        yPos = 185;
        doc.setFontSize(12);
        doc.setFont('helvetica', 'bold');
        doc.text('VISTO E ACCETTATO', 105, yPos, { align: 'center' });
        doc.setFont('helvetica', 'normal');
        yPos += 25;
